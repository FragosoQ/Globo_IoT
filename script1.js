...
const renderer = new THREE.WebGLRenderer({ antialias: true, alpha: true }); // Alpha true ajuda na transparência geral
...
async function init() {
    try {
        ...
        // 2.3 Preparar os ARCOS ALEATÓRIOS
        ...
        Globe = new ThreeGlobe()
            .globeImageUrl('https://static.wixstatic.com/media/a6967f_e10f9067a0384262a5386ff479b139c9~mv2.png')
        ...
        // --- NOVA CONFIGURAÇÃO: GLOBO TRANSLÚCIDO ---
        const globeMaterial = Globe.globeMaterial();
        globeMaterial.transparent = true; 
        globeMaterial.opacity = 0.5; // Ajuste este valor (0.0 a 1.0) para mais ou menos transparência
        globeMaterial.color = new THREE.Color(0x000000); // Força a base a ser preta
        // --------------------------------------------
